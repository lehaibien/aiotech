...
public class OrderService : IOrderService
{
    ...
    public async Task<Result<List<OrderResponse>>> GetByUsernameAsync(string username,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Result<List<OrderResponse>>> GetRecentOrdersAsync(int count,
        CancellationToken cancellationToken = default)
    {
        var entities = await _unitOfWork
            .GetRepository<Order>()
    ...
    public async Task<Result<OrderDetailResponse>> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
    {
