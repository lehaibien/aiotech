        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackingNumber = table.Column<string>(type: "varchar(max)", unicode: false, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Rating = table.Column<double>(type: "float", nullable: false, defaultValue: 1.0),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewId", x => x.Id);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    Price = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false, defaultValue: 0.0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("85844e35-f6a0-4f8e-90c4-071366bf5ff6"), "system", new DateTime(2025, 2, 5, 10, 15, 51, 419, DateTimeKind.Local).AddTicks(8432), null, null, false, "Admin", null, null },
                    { new Guid("a8b42a83-b1bc-4937-99d9-0aaa70b896e5"), "system", new DateTime(2025, 2, 5, 10, 15, 51, 419, DateTimeKind.Local).AddTicks(8444), null, null, false, "User", null, null }
                });
