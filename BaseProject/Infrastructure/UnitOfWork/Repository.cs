...
public class Repository<T> : IRepository<T> where T : class
{
    ...
    public async Task<IEnumerable<T>> ExecuteStoredProcedureAsync(string storedProcedureName, object model)
    {
        if (_dbContext.Database.GetDbConnection().State == ConnectionState.Closed)
        {
            _dbContext.Database.OpenConnection();
    ...
    public virtual IEnumerable<T> ExecuteStoredProcedure(string storedProcedureName, params SqlParameter[]? parameters)
    {
        if (_dbContext.Database.GetDbConnection().State == ConnectionState.Closed)
        {
            _dbContext.Database.OpenConnection();
