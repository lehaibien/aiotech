...
FROM #TEMP
ORDER BY
    -- Handle sorting dynamically based on @iSort
    CASE
    ...
    CASE
        ...
        END DESC, -- Apply descending sort for Newest
    CASE
        WHEN @iSort = 4 THEN CreatedDate -- For Oldest (Ascending)
        ELSE NULL -- Do nothing for other cases
        END ASC,
    UpdatedDate DESC, -- Secondary sorting for Default
