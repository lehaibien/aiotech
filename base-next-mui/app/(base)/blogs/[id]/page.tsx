...
import type { BaseGetListRequest, PaginatedList, PostPreviewResponse, PostResponse } from "@/types";
...
export default async function PostPage({ params }: { params: { id: UUID } }) {
  ...
  if (post) {
    ...
    if (postResponse.success) {
      relatedPosts = (postResponse.data as PaginatedList<PostPreviewResponse>).items
    ...
    <>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 2 }}>
          ...
          <Link href="/blogs" style={{ display: 'flex', alignItems: 'center', color: 'inherit', textDecoration: 'none' }}>
      ...
      >
        ...
        <Box sx={{ p: { xs: 3, md: 5 } }}>
          ...
          <Box sx={{ 
            ...
            '& figure': { m: 0, my: 3 },
            '& figcaption': { textAlign: 'center', fontStyle: 'italic', mt: 1, color: 'text.secondary' },
                ...
                >
                  ...
                  <CardContent>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <CalendarTodayIcon fontSize="small" sx={{ fontSize: '0.9rem', color: 'text.secondary' }} />
