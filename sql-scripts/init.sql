...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20250205031552_Initial'
)
BEGIN
    CREATE TABLE [Brand] (
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Role] ([Id], [CreatedBy], [CreatedDate], [DeletedBy], [DeletedDate], [IsDeleted], [Name], [UpdatedBy], [UpdatedDate])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250205033227_AddOrderField'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-05T10:32:27.1659614+07:00''
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-05T10:32:27.1659628+07:00''
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250205123243_UpdatePaymentEnum'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-05T19:32:43.0152266+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-05T19:32:43.0152278+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250212152554_AddPost'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-12T22:25:54.2490489+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-12T22:25:54.2490501+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'ALTER TABLE [Product] ADD CONSTRAINT [CK_Product_DiscountPrice] CHECK (DiscountPrice >= 0 AND DiscountPrice <= Price)');
END;
GO
...
BEGIN
    EXEC(N'ALTER TABLE [Product] ADD CONSTRAINT [CK_Product_Price] CHECK (Price > 0)');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250213014822_AddThumbnailToPost'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-13T08:48:21.6444981+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-13T08:48:21.6444997+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250213015349_RemoveTemplate'
)
BEGIN
    DROP TABLE [Template];
END;
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-13T08:53:48.6948124+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-13T08:53:48.6948138+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250213073944_AddConfiguration'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-13T14:39:43.6230757+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-13T14:39:43.6230770+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250214071107_ChangeValueLengthOfConfiguration'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-14T14:11:07.2344964+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-14T14:11:07.2344977+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250217084502_ChangeMisnamedPropertyToCreatedDate'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-17T15:45:01.5343456+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-17T15:45:01.5343473+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250221052119_AddOrderCancelReason'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-21T12:21:18.8041039+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-21T12:21:18.8041052+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250221091615_UpdatePost'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-21T16:16:15.0001212+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-21T16:16:15.0001223+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250222032421_AddAddressToUser'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-22T10:24:20.4875278+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-22T10:24:20.4875290+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250222064824_AddEmailChangeTable'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-22T13:48:23.8090070+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-22T13:48:23.8090084+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250223024344_ChangeRatingToInteger'
)
BEGIN
...
BEGIN
    EXEC(N'ALTER TABLE [Review] ADD CONSTRAINT [CK_Review_Rating] CHECK (Rating >= 0 AND Rating <= 5)');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-23T09:43:44.2449807+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-23T09:43:44.2449825+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250223031710_ChangePostTagNullable'
)
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-23T10:17:09.7093826+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-23T10:17:09.7093839+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250223082953_AddTaxToOrder'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-23T15:29:53.0708009+07:00''
    WHERE [Id] = ''85844e35-f6a0-4f8e-90c4-071366bf5ff6'';
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [Role] SET [CreatedDate] = ''2025-02-23T15:29:53.0708025+07:00''
    WHERE [Id] = ''a8b42a83-b1bc-4937-99d9-0aaa70b896e5'';
    SELECT @@ROWCOUNT');
END;
GO
